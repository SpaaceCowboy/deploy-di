...
export default function BasicTabs() {
  ...
  return (
    ...
    <div className='flex justify-center flex-col items-center sm:px-16 px-6 mt-[6%]'>
    ...
    <Box className='w-[90%] mt-[3%]'>
      ...
      <TabPanel value={value} index={2}>
        ...
        md:flex-row max-w-7l ss:px-10 justify-evenly mx-auto items-center '>
          <div className='flex flex-col space-y-10 mt-10  h-screen'>
            ...
            <form className='flex flex-col space-y-2 w-[100%] lg:w-[60%]  mx-auto '>
                ...
                <button 
                type='submit'
                className='bg-[#F7AB0A] py-5 px-10 rounded-mb font-bold'>
                    Submit
                </button>
            </form>
          </div>
